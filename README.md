...
In this course You can master Python from basic to advance level topic wise in a very structured manner. The repository contains all the source code, projects, problem sets, and additional resources to enhance your expertise.
...
By cloning this project you can learn everything about python from basic to advance in a structure manner with detailed explanation interms of comments
...
1. **Clone the repository** to your local machine using:
   ```sh
   git clone https://github.com/binayak597/pythonLearning
   ```
...
Thanks to https://github.com/CodeWithHarry for helping me in this journey